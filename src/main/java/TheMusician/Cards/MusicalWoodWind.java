...
public class MusicalWoodWind extends CustomCard {


    //~~~~~~~~~~~~~~~~~~ Getting All the Card's Information ~~~~~~~~~~~~~~~~~~//
    public static final String CARD_ID = MusicianMod.makeID("MusicalWoodWind");
    ...
    private static final int UPGRADE_PLUS_WOODWIND_AMT = 1;
    private static final int PERCUSSION_AMT = -1;


    //~~~~~~~~~~~~~~~~~~ Initializing the Card ~~~~~~~~~~~~~~~~~~//
    public MusicalWoodWind() {
        super(CARD_ID, NAME, IMG, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        magicNumber = baseMagicNumber = WOODWIND_AMT;
        exhaust = true;
    ...
    public void upgrade() {
        if (!upgraded) {
            upgradeName();
            upgradeMagicNumber(UPGRADE_PLUS_WOODWIND_AMT);
