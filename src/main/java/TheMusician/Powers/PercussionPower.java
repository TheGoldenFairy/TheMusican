...
public class PercussionPower extends AbstractPower {

    //~~~~~~~~~~~~~~~~~~ Power's Information ~~~~~~~~~~~~~~~~~~//
    private static final String POWER_ID = MusicianMod.makeID("PercussionPower");
    ...
    //~~~~~~~~~~~~~~~~~~ Constructor ~~~~~~~~~~~~~~~~~~//
    public PercussionPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
